...
back -end
databases
froent  -- sever+ backend --- databases

is connect API : applecation program interface
ro_data = 
import json
#print(json)
#data = {"name":"munavathravi"}
#print(type(data))
import json
print(json)
# data = {"name":"munavathravi"}
...
print(type(product))
data1 = json.dumps(product)
print(type(data1))
# #print(product)
# print(type(product))
# inde_dums = json.dumps(product,indent=4)
# print(inde_dums)
# # date2  = json.loads(product)
# print(type(date2))
# #print(data["name"])
#print(type(data))
# res_data = '{"name":"munavathravi"}'
# print(type(res_data))
# #print(res_data["name"])
# jan = json.loads(res_data)
# json.load("./smaple.json")
# print(type(jan))
# # print(jan["name"])
...
# requset
# json 
# dumps = python ojb - json str
# loads =  json - str
# api = application resours interface
# url = unform resoures locator
# import requests 
# print(requests)
